...
function ButtonAlphabet({ children, onClick, value }) {
  return (
    <div>
      <button
        className="button-alphabet-design"
        onClick={onClick}
        value={value}
      >
        {children}
...
export default function App() {
  ...
  function handleAlphabet(value) {
    console.log("first");
    const selectedBooks = bookItems.filter((el) => el.title.startsWith(value));
...
function BookCard({ bookContent }) {
  ...
  return (
    <div className="">
      ...
      <p>
        <strong>author :</strong> {bookContent.author}
      </p>
    </div>
  );
}

function Topbar({ openByAlphabet, openByPage }) {
  return (
    <div className="">
      <div className="topbar-books">Collection of Books </div>
      <div className="arrange-books">
        <p>Browse books By : </p>
        <Button onClick={openByAlphabet}>Alphabet</Button>
        <Button onClick={openByPage}>No Of Pages</Button>
      </div>
    </div>
  );
}
function BooksByAlphabet({ handleAlphabet }) {
  return (
    <div>
      <div className="button-alphabet">
        <ButtonAlphabet
          onClick={(e) => handleAlphabet(e.target.value)}
          value={"A"}
        >
          A
        </ButtonAlphabet>
